...
/* ---- header ---- */
.top{{position:sticky;top:0;z-index:10;background-color:#fff;background-image:linear-gradient(#fff,#fff);
...
@media (prefers-color-scheme:dark){{
 html,body{{background-color:#fff;background-image:linear-gradient(#fff,#fff);color:var(--ink)}}
 .top{{background-color:#fff;background-image:linear-gradient(#fff,#fff)}}
 .langsw{{background:var(--blue);color:#fff}}
 .jump a{{background:#EEF3F9;color:var(--blue)}}
 .item .n.ar,.item .n.en{{color:inherit}}
}}
@media (forced-colors:active){{
 html,body,.top,main,section,.item,.shot{{forced-color-adjust:none;background-color:#fff;background-image:linear-gradient(#fff,#fff)}}
